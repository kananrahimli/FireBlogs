<template>
  <div class="home" >
    ...
    <div class="update row justify-content-between px-5">
      <h3 class="text-uppercase text-dark col-3">Never Miss a Post.Register for  Your free account today !</h3>
      <router-link to="/register" class="text-uppercase "> Register for Fire blogs <i class="fas fa-angle-double-right"></i></router-link>
    </div>
  </div>
</template>
